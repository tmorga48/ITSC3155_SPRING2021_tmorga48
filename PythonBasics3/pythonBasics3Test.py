...
#Test case for ends_with_consonant
    def test_ends_with_consonant(self):
        ...
        self.assertEqual(pythonBasics3.ends_with_consonant("Hello World"), True)

        self.assertEqual(pythonBasics3.ends_with_consonant("I love computer science"), False)

        self.assertEqual(pythonBasics3.ends_with_consonant("Software Engineering is fun"), True)
...
#Test case for ends_with_number
    def test_ends_with_number(self):
        ...
        self.assertEqual(pythonBasics3.ends_with_number("weipongfwergh"), False)

        self.assertEqual(pythonBasics3.ends_with_number("Hello World 12"), True)

        self.assertEqual(pythonBasics3.ends_with_number("Hello World"), False)
